...
**Status:** ✅ Done (2026-04-22, absorbed via `sec4_standalone.tex`)

第四章开头关于 extension spectral sequence 推广到 $H\mathbb{F}_2$-synthetic spectra 的段落已注释掉，替换为简短的 ESS 定义。
...
第四章中关于 "Many arguments for finite $m$..." 和 grading remark 段落已注释掉。
