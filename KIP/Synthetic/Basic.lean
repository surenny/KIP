...
noncomputable def XModLambda.incl (X : Syn) : X ⟶ XModLambda X :=
  (distinguished_cocone_triangle (SyntheticCategory.lam.app X)).choose_spec.choose
...
noncomputable def XModLambda.proj (X : Syn) :
  ...
  (distinguished_cocone_triangle (SyntheticCategory.lam.app X)).choose_spec.choose_spec.choose
...
theorem XModLambda.triangle_distinguished (X : Syn) :
  ...
  (distinguished_cocone_triangle (SyntheticCategory.lam.app X)).choose_spec.choose_spec.choose_spec
