...
\begin{notation}\label{prereq:not:fhat}
    \uses{prereq:prop:syn-distinguished-triangle,prereq:ax:lambda-g-equals-f}
...
\begin{proposition}\label{prereq:prop:fhat-triangle}
    \uses{prereq:prop:syn-distinguished-triangle,prereq:not:fhat,prereq:ax:lambda-g-equals-f}
