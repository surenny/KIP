...
\begin{definition}\label{prereq:def:ess-underlying-complex}
    ...
    \lean{KIP.SpectralSequence.ExtensionSS.underlyingComplex}\leanok
...
\begin{proposition}\label{prereq:prop:ess-e0-iso}
    ...
    \lean{KIP.SpectralSequence.ExtensionSS.e0_iso}\leanok
...
\begin{proposition}\label{prereq:prop:ess-diff-components}
    ...
    \lean{KIP.SpectralSequence.ExtensionSS.diff_components}\leanok
...
\begin{proposition}\label{prereq:prop:ess-d0}
    ...
    \lean{KIP.SpectralSequence.ExtensionSS.d0_eq_gr}\leanok
