...
\begin{definition}\label{def:f-Er-extension}
    ...
    \lean{KervaireInvariant.ExtensionsOnErPage.definition_f_Er_extension}
...
\begin{definition}\label{def:f-Er-crossing}
    ...
    \lean{KervaireInvariant.ExtensionsOnErPage.definition_f_Er_crossing}
...
\begin{proposition}\label{prop:cross-f-Er}
    ...
    \lean{KervaireInvariant.ExtensionsOnErPage.proposition_cross_f_Er}
...
The above Definition~\ref{def:f-Er-crossing}, and Proposition~\ref{prop:cross-f-Er} can be similarly defined and stated for the case $r=\infty$.

\begin{proposition}\label{prop:enfty-extension-quotient}
    \uses{def:f-Er-extension}
    \lean{KervaireInvariant.ExtensionsOnErPage.proposition_enfty_extension_quotient}
