...
\begin{theorem} \label{thm:main}
    ...
    \lean{KervaireInvariant.Introduction.theorem_main}
...
\begin{corollary}\label{cor:kervaire-dimensions}
  \uses{thm:main}
  \lean{KervaireInvariant.Introduction.corollary_kervaire_dimensions}
...
\begin{theorem}[Browder \cite{Browder}] \label{thm:browder}
    \lean{KervaireInvariant.Introduction.theorem_browder}
...
\begin{theorem}[Theorem~\ref{thm:126survives}] \label{thm:h62}
    ...
    \lean{KervaireInvariant.Introduction.theorem_h62}
...
\begin{corollary} \label{cor:2line}
    \uses{thm:h62}
    \lean{KervaireInvariant.Introduction.corollary_2line}
...
\begin{question} \label{que:2theta6}
    \lean{KervaireInvariant.Introduction.question_2theta6}
    Does there exist a $\theta_6$ that has order 2?
\end{question}

\begin{question} \label{que:theta5sq}
    \lean{KervaireInvariant.Introduction.question_theta5sq}
